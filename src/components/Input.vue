<template>
    <form v-on:submit.prevent class="pure-form">
...
<!--        <vue-fontawesome icon="plus-square" size="2"></vue-fontawesome>-->
        <input v-on:keyup.enter="getInput" v-model="task" id="newTask" type="text" placeholder="Add New Task" required="required">
    </form>
</template>
